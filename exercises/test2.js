...
// prototype to add properties and methods on the class obj
...
p1.attack(p2);
console.log("Player1: " + p1.name + " has " + p1.hitpoints + " hitpoints");
console.log("Player2: " + p2.name + " has " + p2.hitpoints + " hitpoints");
...
// map() returns a new array based on the callback function, each element is a result of the callback funct
...
arr.forEach(function(val) {
  ...
  console.log(JSON.stringify(allMales));
  var allNamesMale = [];
  ...
  console.log(JSON.stringify(allNamesMale));

  // promises II
  // Promises are called themselfs
  //include Bluebird promise library for ES5
